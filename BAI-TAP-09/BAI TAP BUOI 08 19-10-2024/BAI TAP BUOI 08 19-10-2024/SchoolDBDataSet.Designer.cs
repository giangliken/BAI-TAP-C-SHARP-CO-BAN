...
namespace BAI_TAP_BUOI_08_19_10_2024 {
    ...
    public partial class SchoolDBDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(int StudentID, string FullName, int Age, string Major) {
...
namespace BAI_TAP_BUOI_08_19_10_2024.SchoolDBDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([StudentID] = @Original_StudentID) AND ([Full" +
                "Name] = @Original_FullName) AND ([Age] = @Original_Age) AND ([Major] = @Original" +
                "_Major))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([StudentID], [FullName], [Age], [Major]) VALUES (@St" +
                "udentID, @FullName, @Age, @Major);\r\nSELECT StudentID, FullName, Age, Major FROM " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [StudentID] = @StudentID, [FullName] = @FullName, [Age] = @Age, [Major] = @Major WHERE (([StudentID] = @Original_StudentID) AND ([FullName] = @Original_FullName) AND ([Age] = @Original_Age) AND ([Major] = @Original_Major));
SELECT StudentID, FullName, Age, Major FROM Student WHERE (StudentID = @StudentID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BAI_TAP_BUOI_08_19_10_2024.Properties.Settings.Default.SchoolDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, FullName, Age, Major FROM dbo.Student";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "DELETE FROM Student WHERE StudentID = @StudentID\r\n";
        ...
        public virtual int Delete(int Original_StudentID, string Original_FullName, int Original_Age, string Original_Major) {
        ...
        public virtual int Insert(int StudentID, string FullName, int Age, string Major) {
        ...
        public virtual int Update(int StudentID, string FullName, int Age, string Major, int Original_StudentID, string Original_FullName, int Original_Age, string Original_Major) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FullName, int Age, string Major, int Original_StudentID, string Original_FullName, int Original_Age, string Original_Major) {
            return this.Update(Original_StudentID, FullName, Age, Major, Original_StudentID, Original_FullName, Original_Age, Original_Major);
        }
